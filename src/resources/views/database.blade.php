    ...
    <div class="card shadow-lg p-4 text-center" style="max-width: 500px; width: 100%;">
        ...
        <form method="POST" action="{{ route('installer.database.save') }}">
            ...
            <div class="d-flex justify-content-between align-items-center mt-4">
                <a href="{{ route('installer.environment') }}" class="btn btn-secondary"><i class="bi bi-arrow-left me-2"></i> Back</a>
                <button type="submit" class="btn btn-primary">Import Database & Next <i class="bi bi-arrow-right ms-2"></i></button>
            </div>
        </form>
    </div>
@endsection
